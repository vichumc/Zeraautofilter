...
async def start(client, message):
            ...
            try:
                ...
                if STREAM_MODE == True:
                    button = [[
                        ...
                        InlineKeyboardButton('𝗕𝗢𝗧 𝗢𝗪𝗡𝗘𝗥', url="https://t.me/Tgxkiller")
                    ],[
        ...
        for file in files:
            ...
            if STREAM_MODE == True:
                button = [[
                    ...
                    InlineKeyboardButton("𝗕𝗢𝗧 𝗢𝗪𝗡𝗘𝗥", url="t.me/Tgxkiller")
                ],[
    ...
    if not files_:
        ...
        try:
            ...
            if STREAM_MODE == True:
                button = [[
                    InlineKeyboardButton('⌬ Mᴏᴠɪᴇ Gʀᴏᴜᴘ', url=f'https://t.me/+7XRfdaOtii82ODE1'),
                    InlineKeyboardButton('✇ Main Channel', url=CHNL_LNK)
                ],[
                    InlineKeyboardButton("𝗕𝗢𝗧 𝗢𝗪𝗡𝗘𝗥", url="t.me/Tgxkiller")
                ],[
